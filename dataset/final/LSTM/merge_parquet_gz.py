...
IN_DIR = Path("/mnt/d/new_Fraud/dataset/final/LSTM/row_gz")
OUT_DIR = Path("/mnt/d/new_Fraud/dataset/final/LSTM/parquet")
# можно оставить так; скрипт сам поймёт формат
PATTERN = "daily_final-*.parquet.gz"

OUT_BASE = "daily_final"
